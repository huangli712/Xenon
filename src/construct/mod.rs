...
//           in from.rs
//           W22T4 additionally adds `pub use from::EyeElement;` here.
...
//           in from.rs
//   W22T8 → impl<A: Element> TensorBase<Owned<A>, Ix0> { fn from_scalar }  in from.rs
pub use from::EyeElement;
...
mod tests {
    ...
    fn compile_anchor_construct_submodule_paths_resolve() {
        // No assertion needed — the `use super::from;`
