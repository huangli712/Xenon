...
| 1.0.1 | 2026-04-08 | 补充 TensorViewMut par_iter_mut 安全性论证 |
| 1.0.2 | 2026-04-08 | 添加编译期静态检查模板 |
| 1.0.3 | 2026-04-08 | 添加 loom/miri 测试策略 |
| 1.0.4 | 2026-04-08 | 添加权威性交叉引用说明、no_std 下 SIMD Arch 缓存替代方案 |
