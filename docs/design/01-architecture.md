...
- `02-dimension.md` v1.2.6、`03-element.md` v1.4.0、`04-complex.md` v2.0.2：维度、元素封闭实现集（含 `CastElement` sealed marker、`ElementType` 权威定义、`Element::ELEMENT_TYPE_NAME` 关联常量）与复数显式构造/运算边界。
- `05-storage.md` v2.0.1、`06-layout.md` v1.3、`07-tensor.md` v2.0.1：存储模式（含 `StorageShared` sealed unsafe marker）、F-order 布局状态与张量核心类型。
...
- `16-shape.md` v2.0.1、`17-indexing.md` v3.0.1、`18-construction.md` v3.0.1、`19-overload.md` v2.0.0、`20-utility.md` v3.0.1、`21-type.md` v2.1.1、`22-output.md` v2.0.1、`23-ffi.md` v3.0.2（`pub use crate::element::ElementType`，路径稳定，ABI 稳定）、`24-workspace.md` v3.0.1、`25-safety.md` v2.0.1、`27-benchmark.md` v2.0.0、`28-tests.md` v2.0.1、`29-documentation.md` v2.0.2：shape、索引、构造、运算符、utility、类型转换、输出、FFI、workspace、线程安全、benchmark、测试与文档边界。
