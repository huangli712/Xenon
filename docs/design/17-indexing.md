...
| 1.0.1 | 2026-04-07 | 补充切片宏设计 |
| 1.0.2 | 2026-04-07 | 补充偏移量计算说明 |
| 1.0.3 | 2026-04-07 | 补充边界检查 API 表 |
| 1.0.4 | 2026-04-08 | 补充依赖关系图 |
| 1.0.5 | 2026-04-08 | 补充 no_std 兼容性 |
| 1.1.0 | 2026-04-08 | 新增 slice_mut 方法 |
| 1.1.1 | 2026-04-08 | 修复 §4.2.3 代码块格式；明确 slice_mut 对广播视图的 panic 行为；修正 HAS_ZERO_STRIDE 描述；补充前置文档引用 |
