...
> 需求参考: `需求说明书 §9.1`, `需求说明书 §9.3`, `需求说明书 §12`, `需求说明书 §13`, `需求说明书 §14`, `需求说明书 §27`, `需求说明书 §28.3`, `需求说明书 §28.4`, `需求说明书 §28.5`
> 范围声明: 范围内
...
| 自动分层     | SIMD 路径选择由 `simd/` 后端内部处理；`dispatch.rs` 只决定是否进入并行执行，用户无需感知                                                             |
...
| 类型     | 内容                                                                                                                                    |
| -------- | --------------------------------------------------------------------------------------------------------------------------------------- |
| 需求映射 | `需求说明书 §9.1`、`需求说明书 §9.3`、`需求说明书 §12`、`需求说明书 §13`、`需求说明书 §14`、`需求说明书 §27`、`需求说明书 §28.3`、`需求说明书 §28.4`、`需求说明书 §28.5` |
...
| 容差边界          | integer: exact; for float/complex reduction and dot, use `需求说明书 §28.3` as the authoritative baseline, with `00-coding.md §7.4` only as an implementation/test reference. |
...
| 理由     | `需求说明书 §9.1` / `需求说明书 §9.3` / `需求说明书 §28.3` 明确要求公开能力可由 SIMD 加速实现，但不能破坏公开语义；因此整数路径只在可证明保持 checked arithmetic 语义时使用 SIMD，否则直接回退标量；浮点/复数路径则采用受控的累加顺序变化与显式容差记录。 |
