...
|------|-----|
| Wave | W9 — Workspace |
| Task | W9T1 — WorkspaceErrorCategory definition + auxiliary enums (WorkspaceBorrowKind, WorkspaceBorrowState, TypedViewRejection), wired into XenonError::Workspace |
| 目标文件 | `src/error.rs` |
| 前置依赖 | W2T2 |
