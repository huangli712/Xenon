...
/// Convenience for benchmark sites that need both owner and view in one call.
/// Caller MUST keep the returned fixture alive for as long as the view is used.
pub fn strided_fixture_1d(n: usize) -> StridedFixture1D {
    StridedFixture1D::new(n)
}
```
...
mod tests {
    ...
    fn test_strided_fixture_view_shape() {
        let fixture = StridedFixture1D::new(8);
